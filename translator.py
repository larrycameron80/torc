'''
Note: The code below only has enough structure and data to prevent the reader
from being totally lost. More comments are coming + some refactoring to
clarify everything. Once you read the blue paper, this file will make
a lot more sense.
